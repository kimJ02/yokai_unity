...
5. **[나] 다음: 로비** — 캐릭터 선택·강화·윤회·뽑기 (2026-09-09 사용자 지시로 앞당겨짐).
   스펙은 `HANDOFF.md` 7번. 로비가 생기면 임시 디버그 키(Tab 캐릭터 전환, 6/7 빌드 선택,
   숫자키 강화)를 정식 UI로 대체하며 **삭제**한다.
6. **[팀원] 섬영 0차 → 드루이드 0차** (진행 중)
