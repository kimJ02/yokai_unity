...
2. **다음 스프린트(신규 기능) 범위는 아직 미정 — 사용자가 팀원과 상의 후 결정 예정(2026-08-29 확인).** 후보: 플레이어 Health/체력바, 몹 종류 추가, 무기 2종째(+ ScriptableObject 데이터 전환), 아이템, 가챠, 지역 등. 세션이 임의로 정하지 말 것(HANDOFF.md 맨 아래 "따로 논의" 참고).
